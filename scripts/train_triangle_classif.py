...
from s3c.models.heads import TrianglePredictor
...
history = {"epoch": [], "batch": [], 
        "loss": [], "loss_triangle" : [], "loss_label" : [], "classif": []} #, "train_loss_3": []}
        ...
        if (batch_idx + 1) % log_interval == 0:
            ...
            with torch.no_grad():
                for _ in range(5):
                    ...
                    running_triangle += loss_triangle.item()
            ...
            history["loss_triangle"].append(running_triangle / total)
            history["loss_label"].append(running_label / total)

            torch.save({
                    "epoch": epoch,
                    "history": history,
                    "triangle_predictor": triangle_predictor.state_dict(),
